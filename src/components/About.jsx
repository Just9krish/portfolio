        ...
        <div className="about-wrapper">
          ...
          <div className="about-wrapper__info load-hidden">
            <p className="about-wrapper__info-text">
              ...
              desire to create visually stunning and highly efficient websites.
              My unique blend of technical expertise and creative vision allows
              me to approach each project with a fresh perspective, resulting in
              websites that not only look great but also deliver a seamless user
              experience.
            </p>
            <p className="about-wrapper__info-text">
